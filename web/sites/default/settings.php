...
/**
 * The section below is customized for Oomph development.
 */

// Define the project root as a constant to be used later.
defined('PROJECT_ROOT') || define('PROJECT_ROOT', dirname(__DIR__, 3));

// Define the default config sync directory.
$settings['config_sync_directory'] = PROJECT_ROOT . "/config/common";

// Define all the config split directories.
...
if (getenv('IS_DDEV_PROJECT') == 'true' && is_readable($ddev_settings)) {
  // Assume we are in the local split for a ddev environment.
